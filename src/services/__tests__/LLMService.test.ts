...
describe('LLMService', () => {
    ...
    describe('generateCommitMessage', () => {
        ...
        it('should throw error when response is empty', async () => {
            ...
            await expect(llmService.generateCommitMessage(mockChanges, mockConfig))
                .rejects.toThrow('生成的提交信息为空');
        });
