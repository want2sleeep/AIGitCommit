    ...
    beforeEach(() => {
        ...
        mockProviderManager = {
            getProviders: jest.fn(() => [
                { id: 'openai', name: 'OpenAI', defaultBaseUrl: 'https://api.openai.com/v1', defaultModel: 'gpt-3.5-turbo', description: 'OpenAI官方API服务' },
                { id: 'azure-openai', name: 'Azure OpenAI', defaultBaseUrl: 'https://<your-resource>.openai.azure.com', defaultModel: 'gpt-35-turbo', description: 'Microsoft Azure OpenAI服务' },
                { id: 'ollama', name: 'Ollama', defaultBaseUrl: 'http://localhost:11434/v1', defaultModel: 'llama2', description: '本地Ollama服务' },
                { id: 'custom', name: '其他', defaultBaseUrl: '', defaultModel: '', description: '自定义OpenAI兼容服务' }
            ]),
            getProviderById: jest.fn(),
            getDefaultConfig: jest.fn()
        } as any;

        panelManager = ConfigurationPanelManager.getInstance(mockContext, mockConfigManager, mockProviderManager);
    });
    ...
    describe('handleMessage', () => {
        ...
        describe('load command', () => {
            ...
            it('should show error message when loading fails', async () => {
                ...
                expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(expect.stringContaining('加载配置失败'));
            });
        });
        ...
        describe('save command', () => {
            ...
            it('should show error message when saving fails', async () => {
                ...
                expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(expect.stringContaining('保存配置失败'));
                expect(mockWebview.postMessage).toHaveBeenCalledWith({
                    command: 'saveResult',
                    data: {
                        success: false,
