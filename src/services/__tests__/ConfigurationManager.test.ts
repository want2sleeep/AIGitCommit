...
describe('ConfigurationManager', () => {
    ...
    describe('setProvider', () => {
        ...
        it('should set provider to workspace configuration when specified', async () => {
            ...
            expect(mockConfig.update).toHaveBeenCalledWith('provider', 'azure-openai', vscode.ConfigurationTarget.Workspace);
        });
    });
    ...
    describe('saveFullConfig', () => {
        it('should save all configuration values including provider', async () => {
            ...
            expect(mockConfig.update).toHaveBeenCalledWith('commitFormat', 'simple', vscode.ConfigurationTarget.Global);
            expect(mockConfig.update).toHaveBeenCalledWith('maxTokens', 1000, vscode.ConfigurationTarget.Global);
            expect(mockConfig.update).toHaveBeenCalledWith('temperature', 0.5, vscode.ConfigurationTarget.Global);
        });
        ...
        it('should save to workspace configuration when specified', async () => {
            ...
            expect(mockConfig.update).toHaveBeenCalledWith('provider', 'openai', vscode.ConfigurationTarget.Workspace);
            expect(mockConfig.update).toHaveBeenCalledWith('apiEndpoint', 'https://api.openai.com/v1', vscode.ConfigurationTarget.Workspace);
        });
    });
    ...
    describe('migrateConfiguration', () => {
        ...
        it('should infer provider from endpoint when provider not configured', async () => {
            ...
            expect(mockConfig.update).toHaveBeenCalledWith('provider', 'azure-openai', vscode.ConfigurationTarget.Global);
        });
    ...
    describe('inferProviderFromEndpoint', () => {
        ...
        it('should infer openai from OpenAI official endpoint', async () => {
            ...
            expect(mockConfig.update).toHaveBeenCalledWith('provider', 'openai', vscode.ConfigurationTarget.Global);
        });
        ...
        it('should infer custom for unknown endpoints', async () => {
            ...
            expect(mockConfig.update).toHaveBeenCalledWith('provider', 'custom', vscode.ConfigurationTarget.Global);
        });
